...
static const char DriverName[] = "QSQLCIPHER_ARIA";     // interface name for aria
#else
static const char DriverName[] = "QSQLCIPHER_OPENSSL";  // interface name for openssl
#endif
...
#if defined (SQLCIPHER_CRYPTO_ARIA)
    // use cipher aria
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QSqlDriverFactoryInterface" FILE "QSqlCipherDriverPlugin_aria.json")
#else
    // use cipher openssl
    Q_PLUGIN_METADATA(IID "org.qt-project.Qt.QSqlDriverFactoryInterface" FILE "QSqlCipherDriverPlugin_openssl.json")
#endif
