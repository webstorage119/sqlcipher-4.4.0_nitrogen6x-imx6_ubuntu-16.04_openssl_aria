...
#ifndef QSQLCIPHERDRIVER_H
#define QSQLCIPHERDRIVER_H

#include <QtSql/QSqlDriver>

#include "sqlcipher_global.h"

struct sqlite3;

#ifdef QT_PLUGIN
#define Q_EXPORT_Q_SQLCIPHER_DRIVER
#else
#define Q_EXPORT_Q_SQLCIPHER_DRIVER Q_SQL_EXPORT
#endif
...
class Q_EXPORT_Q_SQLCIPHER_DRIVER QSqlCipherDriver : public QSqlDriver
{
    Q_OBJECT
